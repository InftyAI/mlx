...
```
mlxr      (safe, idiomatic Rust API)   <- crates/mlxr
mlxr-sys  (raw unsafe FFI bindings)    <- crates/mlxr-sys, generated by bindgen
...
Runnable examples live in `crates/mlxr/examples`:
